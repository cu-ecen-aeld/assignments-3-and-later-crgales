...
void test_validate_my_username()
{
     ...
     */
    char *my_name, *stored_name;
    my_name = (char  *)my_username();
    stored_name = malloc_username_from_conf_file();
    TEST_ASSERT_EQUAL_STRING_MESSAGE(my_name, stored_name, "The names do not match");
